#!/usr/bin/env python
import os
from carzen.settings import BASE_DIR, INSTALLED_APPS
if __name__ == '__main__':
    destination = os.path.join(BASE_DIR, 'carzen', 'static')
    for app in [_.split('.')[0] for _ in INSTALLED_APPS if not _.startswith('django')]:
